...
class AppliesControllerTest < ActionController::TestCase
  ...
  test "should create apply" do
    assert_difference('Apply.count') do
      post :create, apply: { integer: @apply.integer, position_id: @apply.position_id, status: @apply.status, user_id: @apply.user_id }
    end
  ...
  test "should update apply" do
    put :update, id: @apply, apply: { integer: @apply.integer, position_id: @apply.position_id, status: @apply.status, user_id: @apply.user_id }
    assert_redirected_to apply_path(assigns(:apply))
  end
